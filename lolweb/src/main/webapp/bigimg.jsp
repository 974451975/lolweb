...
<div align="center" style="margin-top:50px ;">
    ...
    <div style="font-size: 28px; color:#c4b998 ; ">图片详情</div>
    <hr style="width: 60% ; color:#927345;" />
    <div align=" center " style="width: 100%;height: auto; margin-top: 50px;" >
        <%--        <ul id="showheroimg">--%>
        <%--            <c:forEach items="${sessionScope.list}" var="hero">--%>
        <%--                <li style='float: left; margin: 20px 1%; border:1px Solid #927345;height: 350px;width:30%;overflow: hidden'>--%>
        <%--                    <img src="images/${hero.heroimg_img}" style='width:100%;height:100%;'>--%>
        <%--                </li>--%>
        <%--            </c:forEach>--%>
        <%--        </ul>--%>

        <img src="images/${param.imgkey}" style="height: 800px;width: 1500px">
...
<div style="clear: both; height: 200px; " align="center">
    <hr style="width: 60% ; color:#927345;" />
<%--    <div><a href="#"><font style="color: #c4b998;">下载图片</font></a></div>--%>
</div>
</body>
