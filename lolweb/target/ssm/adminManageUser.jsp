    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li ><a href="admincontroller/queryAllForum.do?page=1">帖子管理</a></li>
            ...
            <%--            </ul>--%>
            <ul class="nav nav-sidebar">
                <li class="active"><a href="adminManageUser.jsp">用户</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <script>
                        $(document).ready(function(){
                            var str="";
                            $.getJSON("admincontroller/queryAllUser.do",function(data){

                                if(data!=null){
                                    for(var i=0;i<data.length;i++){
                                        str=str+"<tr ><td>"+data[i].user_id+"</td>"+
                                            "+<td>"+data[i].user_name+"</td>"+
                                            "+<td>"+data[i].user_sex+"</td>"+
                                            "+<td>"+data[i].user_email+"</td>"+
                                            "+<td><a href='admincontroller/deleteUserById.do?id="+data[i].user_id+" ' name='delete' onClick=\"if(!confirm('是否确认删除？'))return false;\">删除</a></td>"
                                    }
                                    $("#showuser").html(str);
                                }
                            });
                    ...
                    <%--                    <tr >--%>
                    <%--                        <td>1</td>--%>
                    <%--                        <td>${requestScope.userlist.user_name}</td>--%>
                    <%--                        <td>${requestScope.userlist.user_tel}</td>--%>
                    <%--                        <td>${requestScope.userlist.user_sex}</td>--%>
